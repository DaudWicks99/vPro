...
public class AdapterLkfCategory extends RecyclerView.Adapter<AdapterLkfCategory.ViewHolder> {
    ...
    public AdapterLkfCategory(Context context, ArrayList<MenuHome> menuHomes, HomeFragment fragment){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Log.e("image",url);
        holder.judulLKF.setSelected(true);
        ...
        checkAdmin(holder.editLKF, holder.deleteLKF);
        holder.deleteLKF.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        holder.editLKF.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
