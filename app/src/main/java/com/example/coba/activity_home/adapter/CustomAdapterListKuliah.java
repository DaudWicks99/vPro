...
public class CustomAdapterListKuliah extends BaseAdapter {
    LayoutInflater inflater;
    Context ctx;
    ArrayList<listItem> items;
    ArrayList<listItem> filterList;
    BPMFFragment fragment;
    String sToken;


    public CustomAdapterListKuliah(Context c, ArrayList<listItem> items, BPMFFragment fragment){
        this.ctx= c;
        this.items=items;
