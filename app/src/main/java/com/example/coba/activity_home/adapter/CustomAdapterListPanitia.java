...
public class CustomAdapterListPanitia extends BaseAdapter {
    LayoutInflater inflater;
    Context ctx;
    ArrayList<listItem> items;
    ArrayList<listItem> filterList;
    KEPANITIAANFragment fragment;
    String sToken;


    public CustomAdapterListPanitia(Context c, ArrayList<listItem> items, KEPANITIAANFragment fragment){
        this.ctx= c;
        this.items=items;
