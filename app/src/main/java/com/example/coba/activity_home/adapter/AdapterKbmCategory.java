...
public class AdapterKbmCategory extends RecyclerView.Adapter<AdapterKbmCategory.ViewHolder> {
    ...
    public AdapterKbmCategory(Context context, ArrayList<MenuHome> menuHomes, HomeFragment fragment){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Log.e("image",url);
        holder.judulKBM.setSelected(true);
        ...
        checkAdmin(holder.editKBM, holder.deleteKBM);
        holder.deleteKBM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        holder.editKBM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
