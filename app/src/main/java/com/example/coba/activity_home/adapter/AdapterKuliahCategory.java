...
public class AdapterKuliahCategory extends RecyclerView.Adapter<AdapterKuliahCategory.ViewHolder>{
    ...
    public AdapterKuliahCategory(Context context, ArrayList<MenuHome> menuHomes, HomeFragment fragment){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Log.e("image",url);
        holder.judulKULIAH.setSelected(true);
        ...
        checkAdmin(holder.editKULIAH, holder.deleteKULIAH);
        holder.deleteKULIAH.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        holder.editKULIAH.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
